...
export default function App(){
  ...
  return(
    <div style={{maxWidth:430,margin:"0 auto",minHeight:"100vh",position:"relative"}}>
      ...
      {page!=="admin"&&(<div style={{position:"fixed",bottom:"calc(env(safe-area-inset-bottom, 0px) + 10px)",left:"50%",transform:"translateX(-50%)",width:"calc(100% - 32px)",maxWidth:398,background:P.card,borderRadius:20,boxShadow:"0 4px 24px rgba(0,0,0,0.10)",display:"flex",zIndex:50,border:"1px solid "+P.border}}>
