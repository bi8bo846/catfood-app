...
function CatsPage(props){
  ...
  function typeLabel(t){if(t==="🐛 驅蟲")return "🐛 驅蟲";if(t==="💉 疫苗")return "💉 疫苗";if(t==="🏥 體檢")return "🏥 體檢";if(t==="🌀 其他"||t==="其他")return "🌀 其他";return t||"🌀 其他";}
  return(
          ...
          <div style={{display:"flex",gap:10,overflowX:"auto",paddingBottom:10,scrollbarWidth:"none",msOverflowStyle:"none",alignItems:"center"}}>
            ...
            {cats.map(function(cat){var active=filterCatId===cat.id;return(
              <button type="button" key={cat.id} onClick={function(){setFilterCatId(cat.id);}}
                style={{flexShrink:0,border:"none",background:"none",cursor:"pointer",padding:2}}>
...
export default function App(){
  ...
  return(
    <div style={{maxWidth:430,margin:"0 auto",minHeight:"100vh",position:"relative"}}>
      ...
      {page!=="admin"&&(<div style={{position:"fixed",bottom:"max(14px, env(safe-area-inset-bottom))",paddingBottom:"6px",left:"50%",transform:"translateX(-50%)",width:"calc(100% - 32px)",maxWidth:398,background:P.card,borderRadius:20,boxShadow:"0 4px 24px rgba(0,0,0,0.10)",display:"flex",zIndex:50,border:"1px solid "+P.border}}>
